class RecommendedHomesDomain {
  RecommendedHomesDomain({
    required this.id,
    required this.name,
    required this.image,
  ...
  factory RecommendedHomesDomain.fromMap(Map<String, dynamic> json) {
    return RecommendedHomesDomain(
  ...
  RecommendedHomesDomain copyWith({
    String? id,
    String? name,
    String? image,
    double? rating,
